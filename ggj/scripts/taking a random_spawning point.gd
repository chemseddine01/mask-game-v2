...
func spawn_zombie():
	...
	if random_node ==0:
		...
		elif random_enemy == 1 and Game.first_mask == true:
			get_parent().get_parent().add_child(seconde_enemy)
		elif random_enemy == 2 and Game.first_mask == true:
			print("enmy missing you cant call it now")
		elif random_enemy ==3  and Game.first_mask == true:
			print("enemy missing you cant call it now")
		elif random_enemy == 4 and Game.first_mask == true:
			print("enemy missing you cant call it now")
	elif random_node ==1:
